...
% Geometría para Rectangular
\usepackage[papersize={120mm,62.8mm}, hmargin=1cm,vmargin=0.5cm]{geometry}
\backgroundsetup{
    scale=1,
    color=black,
    opacity=0.4,
    ...
    hshift=-1mm,
    vshift=0mm,
    contents={\includegraphics[width=122mm]{FondoEjercicio.jpg}}
}
